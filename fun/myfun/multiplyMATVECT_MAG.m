...
%**************************************************************************
%**************************************************************************
function [JOut_full] = multiplyMATVECT_MAG(JIn0,CP,z_realx,z_realy,z_realz,idxF,idxV,d,Aee,L,M,N,AeeR,idxVR)
...
%%2. Do -Aee*Jin for Jin relative to potentials and add to current outputs
...
JOut_full(num_curr+1:end) = ...
    (JOut_full(num_curr+1:end) - (JIn0(num_curr+1:end)));
